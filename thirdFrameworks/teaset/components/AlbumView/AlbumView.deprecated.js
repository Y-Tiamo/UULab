...
export default class AlbumView extends Component {
  ...
  renderImage() {
    ...
    return (
      <TransformView
        ...
        onWillMagnetic={(translateX, translateY, scale, newX, newY, newScale) =>
          this.onWillMagnetic(translateX, translateY, scale, newX, newY, newScale)
        }
  ...
  render() {
    let { images, thumbs, defaultIndex, index, maxScale, space, control, children, onLayout, onChange, ...others } =
      this.props;
